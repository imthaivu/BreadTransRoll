...
export function ClassDetailModal({
  ...
  const [noteProcess, setNoteProcess] = useState<string>(classItem.noteProcess || "");
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                type="text"
                className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
                value={name}
            ...
            {/* Note Process - Read-only for admin */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
                <FiFileText className="inline mr-2" />
                Ghi chú quá trình học tập (từ giáo viên)
              </label>
              <textarea
                readOnly
                className="w-full rounded-lg border border-gray-300 px-3 py-2 bg-gray-50 text-gray-700 focus:outline-none sm:text-sm resize-y"
                value={noteProcess || "Chưa có ghi chú"}
                rows={4}
                placeholder="Giáo viên chưa thêm ghi chú..."
              />
              <p className="mt-1 text-xs text-gray-500">
                Ghi chú này do giáo viên quản lý. Admin chỉ có thể xem, không thể chỉnh sửa.
              </p>
            </div>
